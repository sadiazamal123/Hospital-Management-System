    ...
    <form>
        <div>
            ...
            <div style="text-align: center">
                ...
                <h2 style=color:blue>Functionalities of Nurse</h2> <br>
                <button class="button1"><a href="create_nurse.jsp" style="text-decoration: none; color: white">Nurse</a> </button><br> <br>
                <button class="button1"><a href="create_room.jsp" style="text-decoration: none; color: white"> Nurse Governs</a> <br> <br></button><br> <br>
