    ...
    <form>
        <div>
            ...
            <div style="text-align: center">
                ...
                <h2 style=color:blue>Functionalities of Doctor</h2> <br>
                <button class="button1"><a href="create_doctor.jsp" style="text-decoration: none; color: white">Doctor</a> </button><br> <br>
                <button class="button1"><a href="create_attend.jsp" style="text-decoration: none; color: white"> Doctor Attend</a> <br> <br></button><br> <br>
