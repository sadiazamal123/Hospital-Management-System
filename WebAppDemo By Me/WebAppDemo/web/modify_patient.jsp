...
<html>
<head>
    <title>Modify Patient Information</title>
    <style>
        body {
            margin-top: 30px;
            margin-left: 400px;
...
<fieldset class="fieldset1">
    <form>
        <div>
            ...
            <h3 style="text-align: center; color: blue">Patient INFORMATION Modify</h3>
            <form method="post" id="create-form">
                <form>
                    <div>
                        ...
                        <label for="Password"><b> Modified Patient Password  </b> </label><br><br>
                        <input type="Password" id="Password" name="Password" />
                        <button type="submit" formaction="/modify_patient-servlet?column=Password" formmethod="post"> <b> Modify Password</b></button><br><br>

                        <label for="Mobileno"><b> Modified Patient Mobile NUmber </b></label><br><br>
                        <input type="number" id="Mobileno" name="Mobileno">
                        <button type="submit" formaction=" /modify_patient-servlet?column=Mobileno" formmethod="post"><b>Modify Mobile NUmber </b></button><br><br>

                        <label for="Age"><b> Modified Patient Age </b> </label> <br><br>
                        <input type="text" id="Age" name="Age">
                        <button type="submit" formaction=" /modify_patient-servlet?column=Age" formmethod="post"><b>Modify Age</b></button><br><br>
