    ...
    <form>
        <div>
            ...
            <div style="text-align: center">
                ...
                <h2 style=color:blue>Functionalities of Receptionist</h2> <br>
                <button class="button1"><a href="create_receptionist.jsp" style="text-decoration: none; color: white">Receptionist</a> </button><br> <br>
                <button class="button1"><a href="create_record.jsp" style="text-decoration: none; color: white">Records</a> <br> <br></button><br> <br>
