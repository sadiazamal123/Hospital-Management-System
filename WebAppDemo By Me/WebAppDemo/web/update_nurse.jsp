...
<fieldset class="fieldset1">
    <form>
        <div>
            ...
            <h3 style="text-align: center; color: blue">NURSE INFORMATION UPDATE</h3>
            <form method="post" id="create-form">
                <form>
                    <div>
                        ...
                        <label for="n1_password"><b> Updated Nurse Password  </b> </label><br><br>
                        <input type="Password" id="n1_password" name="n1_password" />
                        <button type="submit" formaction="/update_nurse-servlet?column=Password" formmethod="post"> <b> Update Password</b></button><br><br>


                        <label for="n1_address"><b> Updated Nurse Address </b> </label> <br><br>
                        <input type="text" id="n1_address" name="n1_address">
                        <button type="submit" formaction=" /update_nurse-servlet?column=Address" formmethod="post"><b>Update Address</b></button><br><br>

                        <label for="n1_salary"><b> Updated Nurse Salary: </b></label><br><br>
                        <input type="number" id="n1_salary" name="n1_salary">
                        <button type="submit" formaction=" /update_nurse-servlet?column=Salary" formmethod="post"><b>Update Salary</b></button><br><br>
                    </div>
                </form>
                <br><br>
            ...
            <button class="button1"><a href="Summary_nurse.jsp" style="text-decoration: none; color: white">Information Summery</a></button><br><br>
