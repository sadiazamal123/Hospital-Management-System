...
<fieldset class="fieldset1">
    <form>
        <div>
            ...
            <h3 style="text-align: center; color: blue">EMPLOYEE INFORMATION UPDATE</h3>
            <form method="post" id="create-form">
                <form>
                    <div>
                        ...
                        <button type="submit" formaction="/update_employee-servlet?column=Password" formmethod="post"> <b> Update Password</b></button><br><br>


                        <label for="Address"><b> Updated Employee Address </b> </label> <br><br>
                        <input type="text" id="Address" name="Address">
                        <button type="submit" formaction=" /update_employee-servlet?column=Address" formmethod="post"><b>Update Address</b></button><br><br>

                        <label for="Salary"><b> Updated Employee Salary: </b></label><br><br>
                        <input type="number" id="Salary" name="Salary">
                        <button type="submit" formaction=" /update_employee-servlet?column=Salary" formmethod="post"><b>Update Salary</b></button><br><br>
                    </div>
                </form>
                <br><br>
