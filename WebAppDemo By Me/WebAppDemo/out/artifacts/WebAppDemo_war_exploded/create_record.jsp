    ...
    <form>
        <div>
            ...
            <form method="post" id="create-form">
                <div>
                    <h3 style="color: darkslateblue; text-align: center">Receptionist Records Information</h3><br><br>
                    <label for="recordid"><b> Record Number: </b></label><input type="number" id="recordid" name="recordid"><br><br>

                    <label for="aofd"> <b>Appointment Date: </b></label> <input type="date" id="aofd" name="aofd"><br><br>
                    <label for="detail"> <b>Patient Information: </b></label>
                    <textarea rows="3" cols="80" id="detail" name="patient-detail"></textarea><br><br>

                    <br><br>
                </div>

                <button class="button1" type="submit" form="create-form" formmethod="post" formaction="/create_employee-servlet" style="text-decoration: none; color: white">Create Record</button>
            </form>
            <br><br><br>
