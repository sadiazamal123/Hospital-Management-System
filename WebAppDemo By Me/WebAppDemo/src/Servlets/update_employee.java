    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if(column.equals("Password"))
            {
                ...
                controller.updateEmployeePassword(Employee_id, Password);

            }

            else if(column.equals("Address"))
            {     String  Address = request.getParameter("Address");
                controller.updateEmployeeAddress(Employee_id,  Address);

            }
            else if(column.equals("Salary"))
            {
                String  Salary = request.getParameter("Salary");
                controller.updateEmployeeSalary(Employee_id,  Salary);
