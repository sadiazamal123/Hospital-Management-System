...
public class modify_receptionist extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            if(column.equals("Password"))
            {
                ...
                controller.modifyReceptionistPassword(Employee_id, Password);

            }

            else if(column.equals("Address"))
            {     String  Address = request.getParameter("Address");
                controller.modifyReceptionistAddress(Employee_id,  Address);

            }
            else if(column.equals("Salary"))
            {
                String  Salary = request.getParameter("Salary");
                controller.modifyReceptionistSalary(Employee_id,  Salary);
